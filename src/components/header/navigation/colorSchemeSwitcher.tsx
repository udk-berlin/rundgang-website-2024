  ...
  return (
    <ColorSchemeSwitcherContainer>
      <button
        ...
        className="border-xs flex h-full w-full items-center justify-center rounded-border border-y-border border-r-border border-primary bg-primary hover:bg-highlight"
      >
