  ...
  return (
    <ColorSchemeSwitcherContainer>
      <button
        ...
        className="flex h-full w-full items-center justify-center rounded-border border-xs border-y-border border-r-border border-primary bg-primary hover:bg-highlight"
      >
