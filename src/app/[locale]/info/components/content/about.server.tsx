...
function InfoContentAboutContainer({ children }: HtmlProps) {
  return (
    <div className="h-fit rounded-b-border rounded-tl-border bg-secondary px-gutter-m pt-gutter-lg md:col-span-2 md:h-content-body md:max-h-content-body md:min-h-content-body md:overflow-y-auto md:rounded-border md:border-r-0 md:px-gutter-m md:py-gutter-lg">
      {children}
    </div>
  );
}
