  ...
  return (
    <main className="relative">
      <div
        ...
        className="h-content max-h-content min-h-content fixed left-[0vw] w-screen overflow-hidden transition-[left] duration-700 md:left-0"
      >
        <div className="grid w-[166.666666vw] grid-cols-5 md:w-screen md:grid-cols-5">
          {children}
        </div>
      </div>
    </main>
