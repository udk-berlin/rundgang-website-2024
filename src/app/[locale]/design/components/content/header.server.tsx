...
function DesignContentHeaderContainer({ children }: HtmlProps) {
  return (
    <div className="fixed  hidden h-header max-h-header min-h-header w-[80vw] bg-primary md:flex">
      <div className="border-b-xs border-r-xs flex h-full w-1/2 items-end justify-stretch rounded-border border-border border-t-0 border-primary bg-secondary px-gutter-md py-gutter-xs">
