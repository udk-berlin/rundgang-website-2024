    ...
    <div className="pointer-events-none relative z-40 col-span-3 h-fit pr-0 sm:h-content sm:overflow-y-scroll sm:overscroll-y-contain">
      ...
      <Suspense fallback="Loading...">
        <div className="bg-primary">
          <div className="pointer-events-auto relative max-h-fit min-h-[35dvh] items-start rounded-md border-border border-b-0 border-primary bg-secondary sm:grid sm:min-h-place sm:grid-cols-2 sm:border-r-0 sm:border-t-border">
