...
export default function Days() {
  ...
  return (
    <div ref={scrollRef} className="sticky left-0 top-0 z-40 h-gridcell pb-10">
      <div className="flex w-full justify-stretch bg-primary px-[1px]">
...
function Day({
  ...
  return (
    <button
      className={cx(
        'h-gridcell grow rounded-md border-border border-x-[1px] border-t-0 border-primary px-4 hover:bg-highlight hover:text-black',
