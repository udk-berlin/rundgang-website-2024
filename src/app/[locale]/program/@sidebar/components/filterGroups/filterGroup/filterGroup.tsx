...
export default async function SidebarFilterGroup({ translation, filters }: FilterGroupProps) {

  return (
    <div className="w-full">
        <SidebarFilterGroupHeader key="filter-group-title" translation={translation} />
